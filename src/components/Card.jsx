...
function Card({name, image, id, price, type}) {
  ...
  return (
    <div className="w-[300px] h-[400px] bg-white p-3 rounded-lg flex flex-col gap-3 shadow-lg hover:border-2 border-green-300">
      ...
      <button className="w-full p-3 bg-green-500 rounded-md r:bg-green-400 cursor-pointer transition-all  shadow-md text-white" onClick={()=>{dispatch(AddItem({id:id,name:name, price: price, image: image, qty:1}))
